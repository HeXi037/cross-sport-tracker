...
import { BOWLING_FRAME_COUNT, MAX_BOWLING_PLAYERS } from "./bowlingConfig";
...
export default function RecordSportForm({ sportId }: RecordSportFormProps) {
  ...
  const buildBowlingRollLabel = useCallback(
    (playerLabel: string, frame: number, roll: number) =>
      recordT("bowling.rollLabel", { playerLabel, frame, roll }),
    [recordT],
  );
  ...
  return (
    <main className="container">
      ...
      <form onSubmit={handleSubmit} className="form-stack">
        ...
        <fieldset className="form-fieldset" disabled={isAnonymous}>
          ...
          {isPadelAmericano && (
            <PadelAmericanoTargetField
              ...
              onChange={setPadelAmericanoTarget}
              label={recordT("padelAmericano.tieTargetLabel")}
              hint={recordT("padelAmericano.tieTargetHint")}
              targetHintId={padelAmericanoTargetHintId}
            />
          )}
          {isPadelAmericano && (
        ...
        {isBowling ? (
          <BowlingEntriesSection
            bowlingEntries={bowlingEntries}
            bowlingValidationErrors={bowlingValidationErrors}
            bowlingFieldErrors={bowlingFieldErrors}
            bowlingTouchedEntries={bowlingTouchedEntries}
            hasAttemptedSubmit={hasAttemptedSubmit}
            players={players}
            sportCopy={sportCopy}
            bowlingRollPlaceholder={bowlingRollPlaceholder}
            bowlingMaxReached={bowlingMaxReached}
            bowlingMaxHintId={bowlingMaxHintId}
            disabled={isAnonymous}
            registerBowlingInput={registerBowlingInput}
            previewBowlingInput={previewBowlingInput}
            getBowlingPlayerLabel={getBowlingPlayerLabel}
            getBowlingFramePinSum={getBowlingFramePinSum}
            getBowlingInputKey={getBowlingInputKey}
            isBowlingRollEnabled={isBowlingRollEnabled}
            buildBowlingRollLabel={buildBowlingRollLabel}
            handleBowlingPlayerChange={handleBowlingPlayerChange}
            handleRemoveBowlingPlayer={handleRemoveBowlingPlayer}
            handleBowlingRollChange={handleBowlingRollChange}
            handleBowlingRollBlur={handleBowlingRollBlur}
            handleBowlingInputKeyDown={handleBowlingInputKeyDown}
            handleAddBowlingPlayer={handleAddBowlingPlayer}
          />
        ) : (
          <>
            <PlayerSelectors
              ...
              handleApplyLastMatch={handleApplyLastMatch}
              selectedPairingKey={selectedPairingKey}
              setSelectedPairingKey={setSelectedPairingKey}
              favouritePairingOptions={favouritePairingOptions}
              handleApplyPairing={handleApplyPairing}
              handleSwapTeams={handleSwapTeams}
              handleRotatePositions={handleRotatePositions}
              playerSearch={playerSearch}
              handlePlayerSearchChange={handlePlayerSearchChange}
              ids={ids}
              handleIdChange={handleIdChange}
              duplicateHintActive={duplicateHintActive}
              duplicateHintId={duplicateHintId}
              ...
              duplicatePlayersHintId={duplicatePlayersHintId}
            />
